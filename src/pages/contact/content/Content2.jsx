...
import { faArrowsUpDown, faChevronDown, faEllipsisH, faFilter, faMagnifyingGlass, faTimes, faUserGroup } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('top')}>
                ...
                <div className={cx('text')}>Danh sách nhóm</div>
            </div>
            <div className={cx('center')}>
                <div className={cx('text1')} >Nhóm(47)</div>
                    ...
                    <div className={cx('top1')}>
                        ...
                        <div className={cx('dropdown')}>
                            <button className={cx('locName')} onClick={toggleMenu1}>
                                ...
                                <div className={cx('optionName')}>Hoạt động (mới - cũ)</div>
